...
<style>
    ...
    .navbar {
        ...
        border-bottom: 1.5px solid #d4e6b0;
        margin-bottom: 44px;
    ...
    .nav-icon {
        ...
        background: linear-gradient(135deg, #2a5218, #4a8e28);
        border-radius: 12px; display: flex; align-items: center;
        justify-content: center; font-size: 20px;
        box-shadow: 0 4px 14px rgba(42,82,24,0.3);
    }
    ...
    .nav-pill {
        background: #e4f0d0; border: 1px solid #aed176;
        color: #3a6b1a; font-size: 10px; font-weight: 700;
        padding: 5px 14px; border-radius: 99px; letter-spacing: 1.2px;
    }

    /* ── Hero ── */
    .hero {
        text-align: center; padding: 8px 0 48px 0;
    ...
    .hero h1 {
        font-size: 44px; font-weight: 700; color: #1a2e0f;
        letter-spacing: -2px; line-height: 1.1; margin: 0 0 18px 0;
    }
    ...
    /* ── Panel labels ── */
    .panel-label {
        font-size: 10px; font-weight: 700; color: #8aaa60;
    ...
    div[data-testid="stFileUploader"] section {
        border: 2px dashed #c0d890 !important;
    ...
    div[data-testid="stFileUploader"] section:hover {
        border-color: #4a8e28 !important;
        background: #f4fae8 !important;
        box-shadow: 0 8px 28px rgba(74,142,40,0.12) !important;
    }
    ...
    .file-tag {
        ...
        background: #fff; border: 1.5px solid #c0d890; border-radius: 12px;
    ...
    /* Healthy — deep green */
    .rcard-healthy {
        background: linear-gradient(140deg, #1b4a0c 0%, #2e7018 60%, #3d8e20 100%);
    ...
    /* Diseased — dark red */
    .rcard-diseased {
        background: linear-gradient(140deg, #4a0e05 0%, #7a2010 60%, #9e3018 100%);
        border: 1.5px solid rgba(255,255,255,0.1);
    }
    ...
    .rlabel-light { font-size: 26px; font-weight: 700; color: #fff; letter-spacing: -0.8px; margin-bottom: 6px; }
    .rlabel-dark  { font-size: 26px; font-weight: 700; color: #1a2e0f; letter-spacing: -0.8px; margin-bottom: 6px; }

    .rconf-light { font-size: 13px; color: rgba(255,255,255,0.7); margin-bottom: 18px; }
    .rconf-dark  { font-size: 13px; color: #7a9a5a; margin-bottom: 18px; }
    ...
    .rbar-fill {
        ...
        animation: barIn 0.9s cubic-bezier(.22,1,.36,1) both 0.35s;
        transform-origin: left;
    }
    .rbar-fill-light { background: rgba(255,255,255,0.9); }
    .rbar-fill-dark  { background: #4a8e28; }

    .rpct-light { font-size: 11px; font-weight: 600; color: rgba(255,255,255,0.55); font-family: 'DM Mono', monospace; }
    .rpct-dark  { font-size: 11px; font-weight: 600; color: #8aaa60; font-family: 'DM Mono', monospace; }

    .rdivider-light { height: 1px; background: rgba(255,255,255,0.12); margin: 18px 0; }
    .rdivider-dark  { height: 1px; background: #d4e6b0; margin: 18px 0; }
    ...
    /* ── Empty state ── */
    .empty-card {
        background: #fff; border: 1.5px solid #d4e6b0;
        border-radius: 22px; min-height: 240px;
    ...
    .empty-icon {
        width: 68px; height: 68px; background: #e4f0d0;
    ...
    div[data-testid="stButton"] > button {
        background: linear-gradient(135deg, #2a5218, #3d8020) !important;
        ...
        box-shadow: 0 4px 16px rgba(42,82,24,0.28) !important;
        transition: all 0.2s ease !important;
    }
    div[data-testid="stButton"] > button:hover {
        background: linear-gradient(135deg, #1e3e12, #2e6018) !important;
        box-shadow: 0 6px 22px rgba(42,82,24,0.38) !important;
        transform: translateY(-1px) !important;
    }
    div[data-testid="stDownloadButton"] > button {
        background: #fff !important; color: #2a5218 !important;
        border: 1.5px solid #c0d890 !important; border-radius: 10px !important;
    ...
    div[data-testid="stDownloadButton"] > button:hover {
        background: #f4fae8 !important; border-color: #4a8e28 !important;
        transform: translateY(-1px) !important;
    }

    /* ── History card ── */
    .hist-card {
        background: #fff; border: 1px solid #ddecc0;
    ...
    .hiw {
        background: #fff; border: 1.5px solid #d4e6b0;
        border-radius: 20px; padding: 32px; margin-top: 40px;
    }
    .hiw-label {
        font-size: 10px; font-weight: 700; color: #8aaa60;
    ...
    .hiw-num {
        ...
        display: flex; align-items: center; justify-content: center;
        flex-shrink: 0; box-shadow: 0 4px 12px rgba(42,82,24,0.25);
    }
    ...
    <div class="hiw-grid">
        ...
        <div class="hiw-step">
            ...
            <div>
                ...
                <div class="hiw-step-s">See the diagnosis and follow the step-by-step recommendations.</div>
            </div>
        </div>
    </div>
</div>
